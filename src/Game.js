        ...
        <div className="container">
            ...
            <div className="flexbox">
                        ...
                        <div className="board">
                            {words.map((ord, i) => (
                                <div className="wordCard" id={'ord' + ord.id} key={ord.id} >
                                    <div>{i + 1}. {capitalize(ord.ord)}</div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="col">
                        ...
                        {words.map((ord, i) => (
                            <div id="svarBord" key={i}>
                                <Board key={ord.id} id={ord.flid} ord={{ ord }} className="board oneCard">
                    ...
                    <div className="col">
                        ...
                        <Board id="board-0" className="board">
                            {shuffle(words).map(ord => (
                                <Card id={ord.id} className="card" draggable="true" key={ord.id}>
                ...
                <div className="row ml-1">
                    <h5>Dragðu skýringu í svardálkinn hjá orðinu sem þú telur að hún eigi við.</h5>
                    <div className="ml-auto mr-3">
                        <a style={{ backgroundColor: 'black', borderColor: 'black' }} className="btn btn-primary text-white mid-gray" onClick={fetchWord}>Birta ný orð</a>
                    </div>
                </div>
